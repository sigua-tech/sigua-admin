        ...
        >
            ...
            <el-form-item label="显示状态" prop="is_show">
                <el-switch
                    ...
                    inline-prompt
                />
                <span class="tips">在用户端导航菜单中是否显示</span>
            </el-form-item>
...
<script setup>
import { ref } from 'vue';
import { listBindings, api } from '../../../stores/articleCategory';
...
const formActions = new FormActions(api, listBindings, formRef, {
    id: 0,
    title: '',
    asc_num: 50,
    brief: '',
...
defineExpose({
    ...
    edit (id) {
        edit(id, { get_parent_options: 1 }).then(resp => {
            parentOptions.value = resp.options;
        });
    }
});
