<template>
    ...
    <div class="box">
        <el-table :data="listData.items" @selection-change="items => selectChange(items)" v-loading="listData.isLoading">
            ...
            <el-table-column prop="goods_count" label="商品数" width="72" align="center"></el-table-column>
...
<script setup>
import { listBindings } from '../../../stores/goodsTag';
import { useCans } from '../../../lib/auth';
import FormDialog from './FormDialog.vue';

// 权限
const cans = useCans('goods.tag', ['create', 'update', 'delete', 'batDelete']);
const {
    listData,
    search,
    load,
