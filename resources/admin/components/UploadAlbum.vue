<template>
    <div class="upload-album">
        ...
        <div class="tips">可上传{{ numLimit }}张以内，格式为 png、jpg、jpeg、gif、webp 的图片。可拖动图片调整顺序。</div>
    </div>
</template>
...
import { xsrfToken } from '../lib/util';
...
// 相册图片列表对象 album 与 props.modelValue 数据格式不同，不能用 computed
const album = ref([]);
